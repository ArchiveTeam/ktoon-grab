...
LUA_SHA1 = get_hash(os.path.join(CWD, 'ktoon.lua'))
...
class WgetArgs(object):
    def realize(self, item):
        ...
        for item_name in item['item_name'].split('\0'):
            ...
            if item_type == 'series':
                wget_args.extend(['--warc-header', 'ktoon-series: '+item_value])
                wget_args.append('https://www.myktoon.com/web/league/detail_list.kt?lguewebtoonseq='+item_value)
            elif item_type == 'episode':
                wget_args.extend(['--warc-header', 'ktoon-episode: '+item_value])
                wget_args.append('https://www.myktoon.com/web/league/viewer.kt?lguetimesseq='+item_value)
            elif item_type == 'asset':
                url = 'https://' + item_value
                wget_args.extend(['--warc-header', 'ktoon-asset: '+url])
...
project = Project(
    title=TRACKER_ID,
    project_html='''
        <img class="project-logo" alt="Project logo" src="https://wiki.archiveteam.org/images/4/4a/Myktoon-icon.png" height="50px" title=""/>
        <h2>케이툰 <span class="links"><a href="https://myktoon.com/">Website</a> &middot; <a href="http://tracker.archiveteam.org/ktoon/">Leaderboard</a> &middot; <a href="https://wiki.archiveteam.org/index.php/케이툰">Wiki</a></span></h2>
        <p>Archiving 케이툰.</p>
    '''
)
